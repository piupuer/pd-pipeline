...
type PipelineServiceClient interface {
	Inference(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *pipelineServiceClient) Inference(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/baidu.paddle_serving.pipeline_serving.PipelineService/inference", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PipelineServiceServer interface {
	Inference(context.Context, *Request) (*Response, error)
...
func (UnimplementedPipelineServiceServer) Inference(context.Context, *Request) (*Response, error) {
...
func _PipelineService_Inference_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PipelineServiceServer).Inference(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/baidu.paddle_serving.pipeline_serving.PipelineService/inference",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PipelineServiceServer).Inference(ctx, req.(*Request))
	}
...
var PipelineService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "baidu.paddle_serving.pipeline_serving.PipelineService",
	HandlerType: (*PipelineServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "inference",
			Handler:    _PipelineService_Inference_Handler,
		},
	},
